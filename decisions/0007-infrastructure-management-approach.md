...
The vast majority of operations are **imperative** (do this now) rather than **declarative**
(ensure this state). gcloud is naturally imperative; Terraform is naturally declarative.
