...
We need to choose how to provision the GCP Compute Engine VM that hosts Claude Code agents. The
VM will be used intermittently (during active development sessions) rather than 24/7.
